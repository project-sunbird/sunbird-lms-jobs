...
class NotificationMessage(actor: Actor, eid: String, mid: String, trace: util.Map[String, String], ets: Long, edata: EventData, context: Context, val `object`: util.Map[String, AnyRef])
